package com.ridesharerental.widgets.dialog;
...
public class PkDialog {
    ...
    public PkDialog(Context context) {
        ...
        animShow = AnimationUtils.loadAnimation(mContext, R.anim.show_view);
        animHide = AnimationUtils.loadAnimation(mContext, R.anim.hide_view);
