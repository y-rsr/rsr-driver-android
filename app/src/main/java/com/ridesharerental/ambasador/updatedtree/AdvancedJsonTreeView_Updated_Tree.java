...
public class AdvancedJsonTreeView_Updated_Tree extends LinearLayout
{
    ...
    public AdvancedJsonTreeView_Updated_Tree(Context context, final Map<String, Object> jsonMap)
    {
        super(context);
        this.contx = context;
    ...
    public AdvancedJsonTreeView_Updated_Tree(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void createTreeViewOfKeepedOptimize(LinkedHashMap<String, Object> jsonMap, Boolean... isVirtualNode) {
        ...
        for (LinkedHashMap.Entry<String, Object> entry : jsonMap.entrySet())
        {
            ...
            final AdvancedTreeItemView_Updated_Tree itemView = new AdvancedTreeItemView_Updated_Tree(getContext());
...
*/
           ...
           /* if(!keyq.equals("id") && !keyq.equals("email") && !keyq.equals("rank") && !keyq.equals("color_code") && !keyq.equals("image") && !keyq.equals("referral_code"))
            ...
            if(keyq.equals("modified"))
            {

                String  modified=(String) entry.getValue();
                ...
                itemView.setTag(R.string.host_iamge, host_iamge);
                itemView.setTag(R.string.referal_code, referal_code);
                itemView.setTag(R.string.modified, modified);
            ...
            itemView.setBtnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v) {
                    ...
                    for (int j = 0; j < rootContainer.getChildCount(); j++) {
                        AdvancedTreeItemView_Updated_Tree childView = (AdvancedTreeItemView_Updated_Tree) rootContainer.getChildAt(j);
                        if (startSearchChildNodes) {            //å¼€å§‹æŸ¥æ‰¾å…¶å­èŠ‚ç‚¹
                            ...
                            if (levelTag > currtLevelTag) {       //å­èŠ‚ç‚¹å¼€å§‹
                                ...
                                if (itemView.btnExpend.getText().equals("-")) {
                                    AdvancedTreeItemView_Updated_Tree currtParent = (AdvancedTreeItemView_Updated_Tree) rootContainer.getChildAt(getParentNodeIndex(rootContainer, levelTag, j));//æ‰¾åˆ°å…¶çˆ¶èŠ‚ç‚¹ï¼Œæ ¹æ®å…¶çˆ¶èŠ‚ç‚¹btnåˆ¤æ–­æ˜¯å¦å±•å¼€
...
//                btnText = "-";
            ...
            if (obj instanceof JSONObjectKeeped) {
                ...
                //åˆ›å»ºå½“å‰èŠ‚ç‚¹
                itemView.setData("", "", "", "", key, size, value, btnText, isVirtualNode != null && isVirtualNode.length == 1 && isVirtualNode[0], isExpend, "one");
                ...
                for (int i = 0; i < (jsonArray).length(); i++)
                {
                    ...
                    if (each != null) {
                        ...
                        //åˆ›å»ºå½“å‰èŠ‚ç‚¹
                        itemView.setData("", "", "", "", key, size, value, btnText, isVirtualNode != null && isVirtualNode.length == 1 && isVirtualNode[0], isExpend, "two");
                        //åˆ›å»ºå­èŠ‚ç‚¹çš„tree
            ...
            {  //åŸºç¡€æ•°æ®ç±»åž‹
                ...
                String modified=(String) itemView.getTag(R.string.modified);
                ...
                itemView.setData(modified, color_code_1, name1, rank_, key, size, value, btnText, isVirtualNode != null && isVirtualNode.length == 1 && isVirtualNode[0], isExpend, "three");
            }
